<div>
    <!-- Add Role Modal -->
    <div class="modal fade UnitEditModal" id="UnitEditModal" tabindex="-1" aria-hidden="true" wire:ignore.self>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5 pb-5">
                    <div class="text-center mb-4">
                        <h1 class="role-title">Edit Unit</h1>
                        <p>Edit Unit Details</p>
                    </div>
                    <!-- Add role form -->
                    <form method="POST" wire:submit.prevent="EditSubmit" class="UnitEditForm">
                        @csrf
                        <div class="block">
                            ...
                            <div class="block-content">
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="text"
                                            class="form-control @error('Model.name') is-invalid @enderror"
                                            wire:model.debounce.300ms="Model.name" placeholder="Category Name"
                                            tabindex="1" />
                                        @error('Model.name')
                                ...
                                <div class="row">
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="number" min="0"
                                            class="form-control @error('Model.price') is-invalid @enderror"
                                    ...
                                    <div class="mb-1 col-md-6">
                                        ...
                                        <input type="number" min="0"
                                            class="form-control @error('Model.quantity') is-invalid @enderror"
                                            wire:model.debounce.300ms="Model.quantity" aria-describedby="quantity"

    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header border-bottom">
                <h4 class="card-title">Add New Expense Detail
            ...
            <hr class="my-0" />
            <div class="card-body">
                <form id="expense_add_form" wire:submit.prevent="submit">
                    ...
                    <div class="row">
                        <div class="mb-1 col-md-6">
                            <label class="form-label" for="vertical-modern-price">Total Amount</label>
                            <input type="number" min="0"
                                class="form-control @error('Model.total_amount') is-invalid @enderror"
                                wire:model.debounce.300ms="Model.total_amount" placeholder="Total Amount"
                                tabindex="1" />

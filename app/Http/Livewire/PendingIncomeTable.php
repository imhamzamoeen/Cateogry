...
final class PendingIncomeTable extends PowerGridComponent
{
    use ActionButton;
    public $status;
    ...
    public function updatedStatus($value, $id)
    {
        ...
        $this->emit('RefreshPendingIncome');
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('created_at_formatted', fn (Income $model) => Carbon::parse($model->created_at)->format('d/m/Y h:i A'))

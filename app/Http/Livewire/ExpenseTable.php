    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('share_by')
            ->addColumn('net_expense', function (Expense $model) {
                return '<strong style="color:blue;">' . $model->net_expense . '</strong>';
            })
            ...
            //         '</select>' . $span;
            // })
            ->addColumn('created_at_formatted', fn (Expense $model) => Carbon::parse($model->created_at)->format('d/m/Y '))
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Net Expense', 'net_expense')->makeInputRange()
                ->sortable()
                ->searchable(),
